...
import {scriptSettings as pipelineSettings, scriptKey as pipelineKey} from './script-settings.mjs';

// Poll local execution state; only an explicit key press may start a script.
export class ScriptController {
  ...
  image(context, state, color, foreground) {
    const image = awsImage('script',state,color,foreground);
