...
export const fields = ['targetLanguage','outputFormat','backgroundColor','iconColor'];
export function textSettings(value = {}) {
 ...
 return {targetLanguage,outputFormat,backgroundColor:backgroundColor(value.backgroundColor),iconColor:iconColor(value.iconColor)};
}
